...
> _"The club's distinguishing feature, and the mechanism that makes 'graded on reasoning, not returns' real rather than rhetorical. This module is cheap to build and is the strongest thing on the site. Do not cut it."_
